...
// Uso de las estructuras de listas provistas por la API de Java. Para resolver
// este punto cree el paquete tp1.ejercicio7

// a. Escriba una clase llamada TestArrayList cuyo método main recibe una secuencia
// de números, los agrega a una lista de tipo ArrayList, y luego de haber agregado
// todos los números a la lista, imprime el contenido de la misma iterando sobre
// cada elemento.

// b. Si en lugar de usar un ArrayList en el inciso anterior hubiera usado un 
// LinkedList ¿Qué diferencia encuentra respecto de la implementación? Justifique

// En este caso concreto lo unico que hubiera cambiado es el constructor de la lista

// c. ¿Existen otras alternativas para recorrer los elementos de la lista del punto
// 7a.?

// Si, se podría usar el metodo Iterator();
...
// e. A la lista del punto 7d, agregue un nuevo estudiante. Antes de agregar,
// verifique que el estudiante no estaba incluido en la lista.

// f. Escriba un método que devuelva verdadero o falso si la secuencia almacenada 
// en la lista es o no capicúa:
...
// g. Considere que se aplica la siguiente función de forma recursiva. A partir de 
// un número n positivo se obtiene una sucesión que termina en 1:
// Por ejemplo si n es par f(n)=n/2 y si n es impar f(n)=3n+1, 
// ejemplo para n= 6, se obtiene la siguiente sucesión:
//	f(6) = 6/2 = 3
//	f(3) = 3*3 + 1 = 10
//	f(10) = 10/2 = 5
//	….
...
public class AplicationEjercicioSiete {
